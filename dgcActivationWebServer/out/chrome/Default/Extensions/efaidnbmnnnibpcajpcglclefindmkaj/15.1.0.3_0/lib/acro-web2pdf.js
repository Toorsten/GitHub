            ...
            if (status === this.STATUS_WAITING) {
				...
				if (request.version === SETTINGS.READER_VER) {
                    analytics.event(analytics.
                                    e.TREFOIL_PDF_DOWNLOAD_OPENED_READER);
                } else {analytics.event(analytics.
                                        e.TREFOIL_PDF_DOWNLOAD_OPENED);
                    }
                state = "pdf_opened";
                ...
                if (request.version === SETTINGS.READER_VER) {
                    analytics.event(analytics.
                                    e.TREFOIL_PDF_DOWNLOAD_OPEN_FAILED_READER);
                } else {analytics.event(analytics.
                                        e.TREFOIL_PDF_DOWNLOAD_OPEN_FAILED);
                           }
